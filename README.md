...
- Learn how to work with a headless CMS.
- Discover where to get nice custom SVG images.
- Understand what a headless CMS is.
- Set up a Contentful account.
- Learn how to store project data on the cloud, fetch it, and display it in a React app.
- Learn how to implement webhooks.
- Ensure that if we make any changes to the project's data on the cloud using the graphical interface, Netlify automatically rebuilds the project.
